      ...
      <div className="mx-auto max-w-screen-xl px-4 py-32 lg:flex">
        <div className="mx-auto max-w-xl text-center">
          <h1 className="text-3xl font-extrabold sm:text-5xl">
            <strong className="text-primary">Safely upload</strong> and{" "}
            <strong className="text-primary">easily share</strong> files with{" "}
            <strong className="text-primary">QuickConnect</strong>, your secure
            all-in-one solution.
          </h1>

          <p className="mt-4 sm:text-xl/relaxed">{Constant.description}</p>
